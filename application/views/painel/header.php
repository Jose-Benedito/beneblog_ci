...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/servico.css'); ?>"/>
     ...
     <script type="text/javascript" src="<?php echo base_url('assets/css/jquery.js'); ?>" charset="utf-8"></script>
     <script src="<?php echo base_url('assets/css/jquery-te.js'); ?>" charset="utf-8"></script>
